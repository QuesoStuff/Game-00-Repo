...
public abstract class Border_Triangle : Border
{
    ...
    public Border_Triangle(float sideLength, GameObject borderObject, float rotate = 0, Transform target = null) : base(borderObject, rotate, target)
    {
        sideLength_ = sideLength;
    }

    public Border_Triangle(BorderParameters parameters, GameObject borderObject, float rotate = 0, Transform target = null) : base(parameters, borderObject, rotate, target)
    {
