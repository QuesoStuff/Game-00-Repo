...
public class Border_Donut : Border
{
    ...
    public Border_Donut(float outerRadius, float innerRadius, GameObject borderObject, float rotate = 0, Transform target = null) : base(borderObject, rotate, target)
    {
        outerRadius_ = outerRadius;
        innerRadius_ = innerRadius;
    }
    public Border_Donut(BorderParameters parameters, GameObject borderObject, float rotate = 0, Transform target = null) : base(parameters, borderObject, rotate, target)
    {
