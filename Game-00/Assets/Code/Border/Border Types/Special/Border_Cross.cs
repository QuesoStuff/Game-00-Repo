...
public class Border_Cross : Border
{
    ...
    public Border_Cross(float armLength, GameObject borderObject, float rotate = 0, Transform target = null) : base(borderObject, rotate, target)
    {
        armLength_ = armLength;
        MakeBorder();
    }

    public Border_Cross(BorderParameters parameters, GameObject borderObject, float rotate = 0, Transform target = null) : base(parameters, borderObject, rotate, target)
    {
