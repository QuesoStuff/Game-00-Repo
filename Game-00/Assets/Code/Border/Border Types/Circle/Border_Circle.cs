...
public class Border_Circle : Border
{
    ...
    public Border_Circle(float radius, GameObject borderObject, Transform target = null) : base(borderObject, 0, target)
    {
        radius_ = radius;
    }
    public Border_Circle(BorderParameters parameters, GameObject borderObject, Transform target = null) : base(parameters, borderObject, 0, target)
    {
