...
public class Border_Square : Border
{
    ...
    public Border_Square(float sideLength, GameObject borderObject, float rotate = 0, Transform target = null) : base(borderObject, rotate, target)
    {
        sideLength_ = sideLength;
    }

    public Border_Square(BorderParameters parameters, GameObject borderObject, float rotate = 0, Transform target = null) : base(parameters, borderObject, rotate, target)
    {
