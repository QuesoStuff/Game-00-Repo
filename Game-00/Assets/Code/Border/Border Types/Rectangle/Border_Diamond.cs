...
public class Border_Diamond : Border
{
    ...
    public Border_Diamond(float width, float height, GameObject borderObject, float rotate = 0, Transform target = null) : base(borderObject, rotate, target)
    {
        width_ = width;
        height_ = height;
    }
    public Border_Diamond(BorderParameters parameters, GameObject borderObject, float rotate = 0, Transform target = null) : base(parameters, borderObject, rotate, target)
    {
