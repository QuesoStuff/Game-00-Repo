...
public class Border_Trapezoid : Border
{
    ...
    public Border_Trapezoid(float base1, float base2, float height, GameObject borderObject, float rotate = 0, Transform target = null) : base(borderObject, rotate, target)
    {
        base1_ = base1;
        base2_ = base2;
        height_ = height;
    ...
    public Border_Trapezoid(BorderParameters parameters, GameObject borderObject, float rotate = 0, Transform target = null) : base(parameters, borderObject, rotate, target)
    {
