...
public class Border_Hexagon : Border
{
    ...
    public Border_Hexagon(float sideLength, GameObject borderObject, float rotate = 0) : base(borderObject, rotate)
    {
        sideLength_ = sideLength;
    }

    public Border_Hexagon(BorderParameters parameters, GameObject borderObject, float rotate = 0) : base(parameters, borderObject, rotate)
    {
