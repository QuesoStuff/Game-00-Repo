...
public class Border_CrescentMoon : Border
{
    ...
    public Border_CrescentMoon(float outerRadius, float innerRadius, GameObject borderObject, float rotate = 0) : base(borderObject, rotate)
    {
        outerRadius_ = outerRadius;
        innerRadius_ = innerRadius;
    }
    public Border_CrescentMoon(BorderParameters parameters, GameObject borderObject, float rotate = 0) : base(parameters, borderObject, rotate)
    {
