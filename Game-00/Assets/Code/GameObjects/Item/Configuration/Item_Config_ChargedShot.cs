...
public class Item_Config_ChargedShot : Item_Config
{
    ...
    public override void Config_Init()
    {
        ...
        currItemConfig_ = CONSTANTS.ITEM_TYPE.CHARGED_SHOT;
    ...
    {
        StartCoroutine(active_.SelectConfig(CONSTANTS.ACTIVE_CONFIG.CHARGED_SHOT, methodStart_, methodBlinking_, methodEnd_, duration_, blinkingTime_));
    }
