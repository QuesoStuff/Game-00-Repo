...
public class Spawning_SFX : Spawning
{
    ...
    public void Spawn_Explosion(Vector3 position, Quaternion rotation, CONSTANTS.EXPLOSION_TYPES explosionType, Color? color = null)
    {
        color ??= Color.white;
    ...
    {
        color ??= Color.white;
        Spawn_Explosion(startPosition, Quaternion.identity, CONSTANTS.EXPLOSION_TYPES.DEATH, color.Value);
    }

    public void Spawn_ExplosionDash(Vector2 startPosition, Color? color = null)
    {
        color ??= Color.white;
        Spawn_Explosion(startPosition, Quaternion.identity, CONSTANTS.EXPLOSION_TYPES.DASH, color.Value);
    }

    public void Spawn_ExplosionDeath_Item(Vector2 startPosition, Color? color = null)
    {
        color ??= Color.white;
        Spawn_Explosion(startPosition, Quaternion.identity, CONSTANTS.EXPLOSION_TYPES.DEATH_ITEM, color.Value);
    }

    public void Spawn_ExplosionHurt(Vector2 startPosition, Color? color = null)
    {
        color ??= Color.white;
        Spawn_Explosion(startPosition, Quaternion.identity, CONSTANTS.EXPLOSION_TYPES.HURT, color.Value);
    }

    public void Spawn_ExplosionBullet(Vector2 startPosition, Color? color = null)
    {
        color ??= Color.white;
        Spawn_Explosion(startPosition, Quaternion.identity, CONSTANTS.EXPLOSION_TYPES.BULLET_WALL_COLLISION, color.Value);
    }
